...
export const jobCreateSchema = z.object({
  ...
  requirements: z.string().min(10, 'Requirements must be at least 10 characters').max(2000),
...
// Relaxed schema for saving drafts (all fields optional, no min-length checks)
