...
export default function StudentProfileModal({
  ...
  // Use studentName as fallback when profile is loading
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      ...
      setError(null)
      try {
        const data = await api.get<StudentProfile>(`/company/students/${studentId}`)
        setProfile(data)
      } catch (err) {
            ...
            <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
              {profile.resumeUrl && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-teal-50 text-teal-600 hover:bg-teal-100 transition-colors text-sm font-medium"
                >
