            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-xs text-gray-400 pt-4 font-medium">
                    ...
                    <div className="md:pl-10">
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="/terms" className="text-gray-500 hover:text-gray-900 transition-colors">Terms</Link></li>
                            <li><Link to="/security" className="text-gray-500 hover:text-gray-900 transition-colors">Security</Link></li>
                        </ul>
                    </div>
